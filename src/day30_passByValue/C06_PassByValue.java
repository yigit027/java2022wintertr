...
public class C06_PassByValue {
    public static void main(String[] args) {
        ...
        //non-primitive data turlerinde obje nin kendisi degil de icindeki elementler
        //degisirse java objenin referansi ve objenin kendisi degismedigi icin element
